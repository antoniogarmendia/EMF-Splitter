 ...
 * </p>
 * <ul>
 *   <li>{@link RepresentationGraph.impl.IconElementImpl#getFilepath <em>Filepath</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IconElementImpl extends NodeElementImpl implements IconElement {
	 ...
	 * @ordered
	 */
	protected static final String FILEPATH_EDEFAULT = "path";
	...
	protected EClass eStaticClass() {
		return RepresentationGraphPackage.Literals.ICON_ELEMENT;
	}
	...
	public void setFilepath(String newFilepath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepresentationGraphPackage.ICON_ELEMENT__FILEPATH, oldFilepath, filepath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepresentationGraphPackage.ICON_ELEMENT__FILEPATH:
				return getFilepath();
		}
