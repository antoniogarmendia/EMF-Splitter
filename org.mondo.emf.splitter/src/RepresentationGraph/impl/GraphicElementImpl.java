 ...
 * </p>
 * <ul>
 *   <li>{@link RepresentationGraph.impl.GraphicElementImpl#getColor <em>Color</em>}</li>
 *   <li>{@link RepresentationGraph.impl.GraphicElementImpl#getPaletteName <em>Palette Name</em>}</li>
 *   <li>{@link RepresentationGraph.impl.GraphicElementImpl#getPaletteIconPath <em>Palette Icon Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GraphicElementImpl extends MinimalEObjectImpl.Container implements GraphicElement {
	 ...
	 * @ordered
	 */
	protected static final String COLOR_EDEFAULT = "blue";
	 ...
	 * @ordered
	 */
	protected static final String PALETTE_NAME_EDEFAULT = "palette";
	 ...
	 * @ordered
	 */
	protected static final String PALETTE_ICON_PATH_EDEFAULT = "iconPath";
	...
	protected EClass eStaticClass() {
		return RepresentationGraphPackage.Literals.GRAPHIC_ELEMENT;
	}
	...
	public void setColor(String newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepresentationGraphPackage.GRAPHIC_ELEMENT__COLOR, oldColor, color));
	}
	...
	public void setPaletteName(String newPaletteName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepresentationGraphPackage.GRAPHIC_ELEMENT__PALETTE_NAME, oldPaletteName, paletteName));
	}
	...
	public void setPaletteIconPath(String newPaletteIconPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepresentationGraphPackage.GRAPHIC_ELEMENT__PALETTE_ICON_PATH, oldPaletteIconPath, paletteIconPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepresentationGraphPackage.GRAPHIC_ELEMENT__COLOR:
				return getColor();
			case RepresentationGraphPackage.GRAPHIC_ELEMENT__PALETTE_NAME:
				return getPaletteName();
			case RepresentationGraphPackage.GRAPHIC_ELEMENT__PALETTE_ICON_PATH:
