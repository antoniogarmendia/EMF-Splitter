...
public class VisibilityAdapterFactory extends AdapterFactoryImpl {
	...
	protected VisibilitySwitch<Adapter> modelSwitch =
		new VisibilitySwitch<Adapter>() {
			@Override
			public Adapter caseMetamodelVisibility(MetamodelVisibility object) {
				return createMetamodelVisibilityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link visibility.MetamodelVisibility <em>Metamodel Visibility</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMetamodelVisibilityAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link visibility.Visibility <em>Visibility</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
