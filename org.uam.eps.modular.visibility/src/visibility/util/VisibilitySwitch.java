...
public class VisibilitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VisibilityPackage.METAMODEL_VISIBILITY: {
				MetamodelVisibility metamodelVisibility = (MetamodelVisibility)theEObject;
				T result = caseMetamodelVisibility(metamodelVisibility);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VisibilityPackage.VISIBILITY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Metamodel Visibility</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Metamodel Visibility</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMetamodelVisibility(MetamodelVisibility object) {
		return null;
	}
