...
public class ConstraintsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConstraintsSwitch<Adapter> modelSwitch =
		new ConstraintsSwitch<Adapter>() {
			@Override
			public Adapter caseMetamodelConstraint(MetamodelConstraint object) {
				return createMetamodelConstraintAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link constraints.MetamodelConstraint <em>Metamodel Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMetamodelConstraintAdapter() {
		return null;
	}
