...
public class VisualizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case VisualizationPackage.EDGE_ELEMENT: {
			...
			case VisualizationPackage.NODE_ELEMENT: {
			...
			case VisualizationPackage.SHAPE: {
				Shape shape = (Shape)theEObject;
				T result = caseShape(shape);
				if (result == null) result = caseNodeElement(shape);
				if (result == null) result = caseGraphicElement(shape);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
