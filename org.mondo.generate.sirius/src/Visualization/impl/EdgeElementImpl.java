 ...
 * <ul>
 *   <li>{@link Visualization.impl.EdgeElementImpl#getSource <em>Source</em>}</li>
 *   <li>{@link Visualization.impl.EdgeElementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EdgeElementImpl extends GraphicElementImpl implements EdgeElement {
	...
	protected EClass eStaticClass() {
		return VisualizationPackage.Literals.EDGE_ELEMENT;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VisualizationPackage.EDGE_ELEMENT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(NodeElement newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizationPackage.EDGE_ELEMENT__SOURCE, oldSource, source));
	}
	...
	public NodeElement getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VisualizationPackage.EDGE_ELEMENT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(NodeElement newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizationPackage.EDGE_ELEMENT__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualizationPackage.EDGE_ELEMENT__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case VisualizationPackage.EDGE_ELEMENT__TARGET:
